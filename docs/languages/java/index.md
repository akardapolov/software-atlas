...
| [09 Concurrency](../../../examples/java/09-concurrency/README.md)                       | Threads, executors, virtual threads, Future, CompletableFuture |
...
| Urma, Fusco, Mycroft         | *Modern Java in Action*           | 2018       | Streams, lambdas, CompletableFuture |
