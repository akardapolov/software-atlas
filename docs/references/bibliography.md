...
- Lamport, L. (1978). "Time, Clocks, and Ordering of Events in a
...
- Helland, P. (2007). "Life beyond Distributed Transactions:
  an Apostate's Opinion." *CIDR 2007*.
...
- Fowler, M. (1999). *Refactoring: Improving Design of Existing Code.*
  Addison-Wesley.
...
- Bernhardt, G. (2012). "Boundaries." *RubyConf.*
